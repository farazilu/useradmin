 ...
 * @version 1.0
 */
class Useradmin_Controller_Admin_User extends Useradmin_Controller_App
{
    ...
    public function action_index()
    {
        ...
        $this->template->content = View::factory('user/admin/index')->set('users', $result)
        ...
        if (! empty($_POST)) {
            ...
            if ($result) {
                ...
                foreach ($_POST['roles'] as $role) {
                    ...
                    $user->add('roles', ORM::factory('Role')->where('name', '=', $role)
                        ->find());
                }
                // message: save success
                Message::add('success', __('Values saved.'));
                // redirect and exit
                HTTP::redirect('admin_user/index');
                return;
            } else {
    ...
    public function action_delete()
    {
        ...
        $this->template->content = View::factory('user/admin/delete')->set('id', $id)->set('data', array(
